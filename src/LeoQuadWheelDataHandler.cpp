...
#endif
{
    LOG(info) << "LeoQuadWheelDataHandler created.";

    BuildPlots();
}

LeoQuadWheelDataHandler::~LeoQuadWheelDataHandler()
{
...
void LeoQuadWheelDataHandler::BuildPlots()
{
#ifdef ENABLE_COM_POS_PLOT
    ...
    _sub_state->AddReceiveCallback(std::bind(
        &LeoQuadWheelDataHandler::OnRecvLeoQuadStateTimeStamped, this,
...
void LeoQuadWheelDataHandler::OnRecvLeoQuadStateTimeStamped(const char *topic_name,
...
void LeoQuadWheelDataHandler::OnRecvLeoQuadState(const double curTime, const dtproto::leoquad::LeoQuadState &state)
{
...
void LeoQuadWheelDataHandler::OnRecvCpgState(const double curTime, const dtproto::leoquad::CpgState &state)
{
    if (_plot_cpgPhi)
    {
...
void LeoQuadWheelDataHandler::OnRecvControlState(const double curTime, const dtproto::leoquad::ControlState &actState, const dtproto::leoquad::ControlState &desState)
{
    if (_plot_footForce)
    {
...
void LeoQuadWheelDataHandler::OnRecvJointState(const double curTime,
...
void LeoQuadWheelDataHandler::OnRecvThreadState(const double curTime, const dtproto::leoquad::ThreadState &state)
{
...
void LeoQuadWheelDataHandler::OnRecvArbitraryState(const double curTime, const dtproto::std_msgs::PackedDouble &state)
{
...
void LeoQuadWheelDataHandler::OnRecvArbitraryStateXY(const double curTime, const dtproto::std_msgs::PackedDouble &state)
{
...
void LeoQuadWheelDataHandler::OnRecvImu(const double curTime, const dtproto::sensor_msgs::Imu &imu)
{
    if (_plot_imu)
    {
...
void LeoQuadWheelDataHandler::OnLoadTriggered(QString filename)
{
#ifndef ROBOT_LEOQUADWHEEL
...
void LeoQuadWheelDataHandler::OnClearTriggered()
{
    _data_seq = 0;
    _msg_seq = 0;
}