...
static ::_pb::Metadata file_level_metadata_DualArm_2eproto[7];
...
void DualArmState::InternalSwap(DualArmState* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(DualArmState, _impl_.arbitrarystate_)
      + sizeof(DualArmState::_impl_.arbitrarystate_)
