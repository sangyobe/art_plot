#ifndef LEOQUADWHEELDATAHANDLER_H
#define LEOQUADWHEELDATAHANDLER_H
...
class LeoQuadWheelDataHandler : public DataHandler
{
    Q_OBJECT
...
public:
    LeoQuadWheelDataHandler(MainWindow *plotToolbox);
    ~LeoQuadWheelDataHandler();
...
#endif // LEOQUADWHEELDATAHANDLER_H